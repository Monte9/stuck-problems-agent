...
| [csam-report-triage](problems/csam-report-triage/) | published | The US CyberTipline got 21.3M child-abuse reports in 2025, but 1.1M came from one sender (Amazon AI Services) and held no actionable information; a 5-stage triage package (completeness rubric, sender noise scorecard, rescue-priority schema, legal constraints, fix map) shows 8 of 13 fixes need no statute, led by a metadata-only triage layer NCMEC and platforms can ship today. [report](problems/csam-report-triage/report.md) · [final artifact](problems/csam-report-triage/artifacts/2026-06-25-m5-fix-attribution-map.md) |
