...
| [osteoporosis-treatment-gap](problems/osteoporosis-treatment-gap/) | published | Only 21.1% of Medicare patients who suffer a fragility fracture are started on bone therapy, even though the atypical-fracture scare that halved US prescribing was backwards (bisphosphonates prevent ~75 hip fractures per atypical fracture caused); closing the gap to a realistic 42% prevents ~3,600 refractures and ~900 deaths/yr, and the fix is one specialty-agnostic Medicare G-code covering the documented $105–$182 per-patient coordination cost. [report](problems/osteoporosis-treatment-gap/report.md) · [final artifact](problems/osteoporosis-treatment-gap/artifacts/2026-06-23-m4-cms-comment-and-fls-business-case.md) |
