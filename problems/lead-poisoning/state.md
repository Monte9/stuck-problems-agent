...
M2 passed evaluation (`verdicts/2026-06-10-m2-attempt0.md`). Per decision table row 2, the next run invokes the generator on M3 (source-attribution profiles for the top 3 countries: Indonesia, Egypt, Philippines), writing `artifacts/YYYY-MM-DD-m3-source-profiles.md`.
