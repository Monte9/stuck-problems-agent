...
2. Build a slate of 3-5 candidates from different domains (medicine/public health, law & regulation, energy & climate, education, scientific literature synthesis, agriculture/food systems, public administration). For each: a 2-3 sentence sketch with the human cost, the half-known solution, and the bottleneck type (missing theory, threatened institutions, misaligned incentives, or sheer grind nobody is staffed to do).
